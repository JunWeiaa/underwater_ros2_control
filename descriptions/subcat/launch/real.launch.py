...
def launch_setup(context, *args, **kwargs):
    ...
    xacro_file = os.path.join(pkg_path, "urdf", "subcat.xacro")
    hardware_params = {
        "robot_name": robot_name,
        "mavros_namespace": context.launch_configurations["mavros_namespace"],
        "servo0_port": context.launch_configurations["servo0_port"],
        "servo1_port": context.launch_configurations["servo1_port"],
        "servo2_port": context.launch_configurations["servo2_port"],
        "servo3_port": context.launch_configurations["servo3_port"],
    }
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument("pkg_description", default_value="subcat"),
            DeclareLaunchArgument("use_sim_time", default_value="false"),
            DeclareLaunchArgument("robot_name", default_value="subcat"),
            DeclareLaunchArgument("robot_namespace", default_value="subcat"),
            ...
            DeclareLaunchArgument("servo0_port", default_value="/dev/ttyACM1"),
            DeclareLaunchArgument("servo1_port", default_value="/dev/ttyACM2"),
            DeclareLaunchArgument("servo2_port", default_value="/dev/ttyACM3"),
            DeclareLaunchArgument("servo3_port", default_value="/dev/ttyACM4"),
