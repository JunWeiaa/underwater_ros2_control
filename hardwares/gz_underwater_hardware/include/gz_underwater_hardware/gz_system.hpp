...
#include "gz_underwater_hardware/gz_system_interface.hpp"
...
public:
    ...
    ~GazeboSimSystem() override = default;
    ...
    double ThrustToAngularVec(double _thrust, double _thrustCoefficient, double _propellerDiameter);
